...
function ActionsCluster({
  ...
  const seg = 'flex items-center gap-1.5 px-2.5 lg:px-3 h-full text-[12px] lg:text-[13px] font-medium text-[#6B7280] hover:text-[#111827] hover:bg-[#F9FAFB] transition-colors';
