...
export const metadata: Metadata = {
  ...
  keywords: [
    "bahai star",
    "nine pointed star",
    "nine-pointed star generator",
    "9 pointed star",
    "bahai symbol",
    "enneagram star",
    "nine star generator",
    "bahai star creator",
    "nine pointed star image",
    "free star generator",
  ],
  ...
  openGraph: {
    ...
    description:
      "Create beautiful nine-pointed star images. Free, customizable, downloadable as SVG, PNG, or JPG.",
    type: "website",
  ...
  twitter: {
    ...
    title: "Nine-Pointed Star Generator",
    description:
      "Create beautiful nine-pointed star images. Free, customizable, downloadable.",
  },
